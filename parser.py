...
def get_parser(root_dir='.'):
    ...
    parser.add_argument("--n-shot-train", type=int, default=1,
                        help="train: number of shot for each class")  # choices=[1,10]
    parser.add_argument("--n-shot-test", type=int, default=1,
                        help="test: number of shot for each class")  # choices=[1,10]
    parser.add_argument("--n-query", type=int, default=4, help="number of query in few shot learning")
